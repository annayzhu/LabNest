...
writeFileSync('docs/debug-20260909/evidence/material-boundary-fixture.json',JSON.stringify({experimentId:experiment.id,inventoryItemId:stock.id}));await prisma.$disconnect();
