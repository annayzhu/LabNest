...
const dir='docs/debug-20260909/evidence/fonts';mkdirSync(dir,{recursive:true});
const fixtures=JSON.parse(readFileSync('docs/debug-20260909/evidence/font-fixtures.json'));
