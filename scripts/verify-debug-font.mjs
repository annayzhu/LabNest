...
const base=process.env.LABNEST_ACCEPTANCE_URL??'http://localhost:3232';assert(['http://localhost:3232','http://localhost:3235'].includes(base));
const out='docs/debug-20260909/evidence/fonts';mkdirSync(out,{recursive:true});
const fixture=JSON.parse(readFileSync('docs/debug-20260909/evidence/font-fixtures.json')).cases.find(c=>c.name==='experiment');
