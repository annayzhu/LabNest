...
const out='docs/stage-20260908/C/evidence';mkdirSync(out,{recursive:true});
const fixture=JSON.parse(readFileSync('docs/stage-20260908/C/fixtures.json')).cases.find(c=>c.name==='experiment');
