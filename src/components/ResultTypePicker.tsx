...
export function ResultTypePicker({ initialTypes, value, onChange }: {
  ...
  return <div className="md:col-span-2">
    ...
    {managing ? <div className="mt-3 space-y-3 rounded-[var(--ln-radius-panel-inner)] border border-hairline bg-warm/70 p-3">
